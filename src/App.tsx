    ...
    <div>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .modal-overlay{position:fixed;inset:0;background:rgba(10,10,10,0.6);backdrop-filter:blur(4px);z-index:999;display:flex;align-items:center;justify-content:center;padding:20px;animation:fadeIn .2s ease-out}
        .modal-card{background:#fff;border:2px solid var(--dark);box-shadow:6px 6px 0 #0a0a0a;border-radius:12px;max-width:440px;width:100%;padding:28px;position:relative}
        .modal-close{position:absolute;top:16px;right:16px;background:none;border:none;font-size:20px;cursor:pointer;font-weight:700}
        .modal-input{width:100%;padding:12px 14px;border:2px solid var(--dark);border-radius:8px;font-size:14px;font-family:var(--font-mono);margin-top:8px;margin-bottom:16px;outline:none}
